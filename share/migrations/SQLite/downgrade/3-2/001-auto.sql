-- Convert schema 'D:\workspace\perl\share\migrations\_source\deploy\3\001-auto.yml' to 'D:\workspace\perl\share\migrations\_source\deploy\2\001-auto.yml':;
...
;
INSERT INTO country_temp_alter( country_id) SELECT country_id FROM country;
